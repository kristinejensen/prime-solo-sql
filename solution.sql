...
SELECT "username" FROM "syntax_practice" WHERE "account_balance" = 0 AND "transactions_attempted" = 0;
...
VALUES ('kris', 'minneapolis', 5, 5, 100.00);
...
SELECT "username" FROM "syntax_practice" WHERE ("city" = 'miami' OR city = 'phoenix') AND  "transactions_completed" < 5;
